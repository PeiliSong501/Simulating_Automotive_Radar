...
class RSSNet(nn.Module):
    def __init__(self, batch_size, radarpoint_dim):
        ...
        # self.local_conv1 = nn.Conv2d(3, 8, kernel_size=3, stride=2, padding=1)    #for ablation use
        #self.local_conv1 = nn.Conv2d(1, 8, kernel_size=3, stride=2, padding=1)     #for ablation use
        ...
        # self.fusion_conv1 = nn.Conv2d(16, 16, kernel_size=3, stride=1, padding=1)  #for ablation use
