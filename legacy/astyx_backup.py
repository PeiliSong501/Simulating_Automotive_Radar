...
if __name__ == '__main__':
    ...
    #     print(f"Range of Yaw (Degree): {yaw_range_degrees[0]:.2f}° 到 {yaw_range_degrees[1]:.2f}°")
    #     print(f"Range of Pitch (Degree): {pitch_range_degrees[0]:.2f}° 到 {pitch_range_degrees[1]:.2f}°")
    # print('Final:')
    # print(f"Range of Yaw (Degree): {lidar_yaw_min:.2f}° 到 {lidar_yaw_max:.2f}°")
    # print(f"Range of Pitch (Degree): {lidar_pitch_min:.2f}° 到 {lidar_pitch_max:.2f}°")
